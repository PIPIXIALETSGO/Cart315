...
public class IsometricCharacterController : MonoBehaviour
{
    ...
    [HideInInspector]
    public Vector3 lastMovedVector=Vector3.zero;
    ...
    void Update()
    {
        ...
        velocity.x = inputVectorMove.toIso().x * player.CurrentMoveSpeed;
        velocity.z = inputVectorMove.toIso().z * player.CurrentMoveSpeed;
